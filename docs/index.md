Problem Statement
===========================
In this Kaggle competition, the goal is to create an algorithm to classify whether images contain either a dog or a cat. 
They are 25000 images in the train set. Each image in this set has the label as part of the filename. 
There are 12500 unlabeled images in the test set.
